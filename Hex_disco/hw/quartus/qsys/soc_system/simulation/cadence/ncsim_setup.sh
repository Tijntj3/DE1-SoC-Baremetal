...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/tijmen/intelFPGA/20.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/switches_0_s1_burst_adapter/
mkdir -p ./libraries/hps_0_h2f_axi_master_wr_limiter/
mkdir -p ./libraries/router_002/
mkdir -p ./libraries/router/
mkdir -p ./libraries/switches_0_s1_agent_rsp_fifo/
mkdir -p ./libraries/switches_0_s1_agent/
mkdir -p ./libraries/hps_0_h2f_axi_master_agent/
mkdir -p ./libraries/switches_0_s1_translator/
mkdir -p ./libraries/hps_io/
mkdir -p ./libraries/fpga_interfaces/
mkdir -p ./libraries/rst_controller/
mkdir -p ./libraries/mm_interconnect_0/
mkdir -p ./libraries/switches_0/
mkdir -p ./libraries/leds_0/
mkdir -p ./libraries/hps_0/
mkdir -p ./libraries/hex_0/
mkdir -p ./libraries/buttons_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_avalon_st_adapter.vhd"                -work avalon_st_adapter               -cdslib ./cds_libs/avalon_st_adapter.cds.lib              
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"                                    -work switches_0_s1_burst_adapter     -cdslib ./cds_libs/switches_0_s1_burst_adapter.cds.lib    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_uncmpr.sv"                             -work switches_0_s1_burst_adapter     -cdslib ./cds_libs/switches_0_s1_burst_adapter.cds.lib    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_13_1.sv"                               -work switches_0_s1_burst_adapter     -cdslib ./cds_libs/switches_0_s1_burst_adapter.cds.lib    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_new.sv"                                -work switches_0_s1_burst_adapter     -cdslib ./cds_libs/switches_0_s1_burst_adapter.cds.lib    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_incr_burst_converter.sv"                                    -work switches_0_s1_burst_adapter     -cdslib ./cds_libs/switches_0_s1_burst_adapter.cds.lib    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_wrap_burst_converter.sv"                                    -work switches_0_s1_burst_adapter     -cdslib ./cds_libs/switches_0_s1_burst_adapter.cds.lib    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_default_burst_converter.sv"                                 -work switches_0_s1_burst_adapter     -cdslib ./cds_libs/switches_0_s1_burst_adapter.cds.lib    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                -work switches_0_s1_burst_adapter     -cdslib ./cds_libs/switches_0_s1_burst_adapter.cds.lib    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv"                                -work switches_0_s1_burst_adapter     -cdslib ./cds_libs/switches_0_s1_burst_adapter.cds.lib    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                  -work switches_0_s1_burst_adapter     -cdslib ./cds_libs/switches_0_s1_burst_adapter.cds.lib    
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                           -work switches_0_s1_agent_rsp_fifo    -cdslib ./cds_libs/switches_0_s1_agent_rsp_fifo.cds.lib   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                      -work switches_0_s1_agent             -cdslib ./cds_libs/switches_0_s1_agent.cds.lib            
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                               -work switches_0_s1_agent             -cdslib ./cds_libs/switches_0_s1_agent.cds.lib            
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                 -work switches_0_s1_translator        -cdslib ./cds_libs/switches_0_s1_translator.cds.lib       
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_switches_0.vhd"                                         -work switches_0                      -cdslib ./cds_libs/switches_0.cds.lib                     
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_leds_0.vhd"                                             -work leds_0                          -cdslib ./cds_libs/leds_0.cds.lib                         
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_hex_0.vhd"                                              -work hex_0                           -cdslib ./cds_libs/hex_0.cds.lib                          
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_buttons_0.vhd"                                          -work buttons_0                       -cdslib ./cds_libs/buttons_0.cds.lib                      
